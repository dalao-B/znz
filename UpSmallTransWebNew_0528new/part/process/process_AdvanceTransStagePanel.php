<div class="easyui-layout" data-options="fit:true">
    ...
    <span style="padding-left: 5px ;width: 100%">成单日期：
        <span><input id="StartDate" type="text" class="easyui-datebox"  name='StartDate' value="2020-03-06" style="width:120px;"></span>
        -
        ...
        <span id=''>
            <input type="radio" name="UnitType4" value="3" onclick={ColumnSort_RadioFun()} checked="true"/>用户上拽期
        </span>
    </span>
    ...
    <div data-options="region:'center'">
        ...
        <select  class="easyui-combobox" name="serviceLevelId"
                 ...
                 style="width:120px;">
            <option name="UnitType5" value="-1">所有</option>
            <option name="UnitType5" value="1">360所有</option>
            <option name="UnitType5" value="4">360老用户</option>
            <option name="UnitType5" value="5">360新用户</option>
            <option name="UnitType5" value="2">3600所有</option>
            <option name="UnitType5" value="6">3600老用户</option>
            <option name="UnitType5" value="7">3600新用户</option>
            <option name="UnitType5" value="3">18000</option>
        </select>
        </span>
            <!--        <span>-->
            <!--        人员类型：-->
...
<script type="text/javascript">
    $(function () {
        ...
        // 向后台传递日期等参数变量
         function getData(){
            ...
            var sourceType = $('option[name="UnitType5"]:checked').val();
    ...
    function ColumnSort_RadioFun() {
        ...
        switch (columnsort) {
            case 1:
                $('#dg').datagrid({columns: process_AdvanceTransStage_1});
                break;
            case 2:
                $('#dg').datagrid({columns: process_AdvanceTransStage_2});
                break;
            case 3:
                $('#dg').datagrid({columns: process_AdvanceTransStage_3});
                break;
        }
    }
