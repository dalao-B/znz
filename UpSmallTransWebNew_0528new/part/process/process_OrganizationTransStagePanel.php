<div class="easyui-layout" data-options="fit:true">
    ...
    <span style="padding-left: 5px ;width: 100%">成单日期：
        <span><input id="StartDate" type="text" class="easyui-datebox"  name='StartDate' value="2019-05-17" style="width:120px;"></span>
        -
    ...
    <div data-options="region:'center'">
        ...
        <select  class="easyui-combobox" name="serviceLevelId"
            ...
            <option name="UnitType5" value="1">18000所有</option>
        </select>
        </span>
            <!--        <span>-->
            <!--        人员类型：-->
        ...
        <select class="easyui-combobox" name="ClassName"
            ...
            <option name="UnitType7" value="8">报名人数</option>
        </select>
        </span>
...
<script type="text/javascript">
    $(function () {
        ...
        $('#dg').datagrid().datagrid({
            ...
            columns:process_OrganizationStage_3,
         ...
         function getData(){
            ...
            var id = $('#MainTree').tree('getSelected').id;
             $.ajax({
                 ...
                 data: {
                     "command": "getOrganizationGuoChengInfo",
                     "startDate": StartDate,
                     "endDate": EndDate,
                     "id": id,
                     "type": meType,
    ...
    function ColumnSort_RadioFun() {
        ...
        switch (columnsort) {
            case 1:
                $('#dg').datagrid({columns: process_OrganizationStage_1});
                break;
            case 2:
                $('#dg').datagrid({columns: process_OrganizationStage_2});
                break;
            case 3:
                $('#dg').datagrid({columns: process_OrganizationStage_3});
                break;
        }
    }
