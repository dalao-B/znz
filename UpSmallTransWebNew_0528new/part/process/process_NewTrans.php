<div id="tabs" class="easyui-tabs" data-options="fit:true">
    <div title="0->360新单统计"  data-options="href:'part/process/process_NewTransStagePanel.php'"></div>
<!--    <div title="0->360用户成熟度统计" style="overflow: hidden" data-options="href:'part/process/process_NewClassBChange_DetailPanel.php'"></div>-->
<!--    <div title="0->360淘人系统" style="overflow: hidden" data-options="href:'part/process/process_NewTransStage_obsoletePanel.php'"></div>-->
    <div title="0->360新单历史统计" data-options="href:'part/process/process_NewTransStageHistoryPanel.php'"></div>
</div>
